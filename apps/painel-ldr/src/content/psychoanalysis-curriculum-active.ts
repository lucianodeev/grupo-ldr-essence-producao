...
import { enhancePsychoanalysisCurriculum } from "@/content/psychoanalysis-advanced-rigor";
...
export const psychoanalysisModules=enhancePsychoanalysisCurriculum(baseActiveModules);
