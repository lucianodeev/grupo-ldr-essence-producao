...
export const stageExternalPublicJob=createServerFn({method:"POST"})
 ...
 .handler(async({data,context})=>{
  ...
  const row:any={
   ...
   external_work_mode:clean(data.workMode,40)||null,external_contract_type:clean(data.contractType,60)||null,external_publication_language:clean(data.publicationLanguage,8)||null,
