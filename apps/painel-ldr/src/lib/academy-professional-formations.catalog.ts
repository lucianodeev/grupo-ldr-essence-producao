...
export const PROFESSIONAL_FORMATIONS:PF[]=[...LEGACY_PROFESSIONAL_FORMATIONS,...NEW_PROFESSIONAL_FORMATIONS,...HEALTH_PSYCHOANALYSIS_FORMATIONS,...TRICHOLOGY_FORMATION,...PROJECT_MANAGEMENT_FORMATION];
