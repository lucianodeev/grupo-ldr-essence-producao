...
import { NEUROSCIENCE_OFFICIAL_FORMATION } from "@/lib/neuroscience-official-formation.catalog";
...
export const PROFESSIONAL_FORMATIONS: PF[] = [
  ...LEGACY_PROFESSIONAL_FORMATIONS,
  ...NEW_PROFESSIONAL_FORMATIONS,
  ...HEALTH_WITHOUT_NEUROSCIENCE,
  ...NEUROSCIENCE_OFFICIAL_FORMATION,
