...
export function EditorialSalesCards(){
  ...
  return <section id="editorial-ldr-sales" className="bg-[#f7f3e9] px-4 py-14 sm:px-6">
    <div className="mx-auto max-w-7xl">
      ...
      <p className="mt-4 text-xs text-slate-500">{locale==="pt"?"Assinatura semanal independente da Biblioteca LDR.":locale==="fr"?"Abonnement hebdomadaire indépendant de la Bibliothèque LDR.":locale==="es"?"Suscripción semanal independiente de la Biblioteca LDR.":"Weekly subscription independent from the LDR Library."}</p>
    </div>
  </section>;
}
