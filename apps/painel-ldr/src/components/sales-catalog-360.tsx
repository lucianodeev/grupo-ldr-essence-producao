...
const COPY = {
  pt:{eyebrow:"VISÃO 360° DA LDR ESSENCE ACADEMY",title:"Encontre tudo sem precisar rolar a página inteira",sub:"Formações, conteúdos gratuitos, livros, orientações e assinaturas em uma visão rápida.",search:"O que você quer aprender?",all:"Todos",formations:"Formações",free:"Grátis",books:"Livros",guidance:"Orientações",publications:"Publicações",subscriptions:"Assinaturas",seeAll:"Ver catálogo completo",from:"a partir de",month:"mês",week:"semana",online:"100% online",formationList:"Vendas · Marketing · RH · Gestão · Comunicação · Psicanálise · Psicanálise Internacional 🌍 · Massoterapia · IA e mais",freeText:"Comece por conteúdos gratuitos antes de escolher uma formação.",booksText:"eBooks e livros digitais para leitura no seu ritmo.",guidanceText:"Orientação Psicanalítica e Profissional por texto.",publicationText:"Jornal LDR · Revista LDR · LDR Ciência.",subText:"Acesse vários conteúdos digitais com a LDR Essence Academy.",noResult:"Nenhuma categoria encontrada."},
  en:{eyebrow:"360° LDR ESSENCE ACADEMY VIEW",title:"Find everything without scrolling through the whole page",sub:"Training, free content, books, guidance and subscriptions in one quick view.",search:"What do you want to learn?",all:"All",formations:"Training",free:"Free",books:"Books",guidance:"Guidance",publications:"Publications",subscriptions:"Subscriptions",seeAll:"View full catalogue",from:"from",month:"month",week:"week",online:"100% online",formationList:"Sales · Marketing · HR · Management · Communication · Psychoanalysis · International Psychoanalysis 🌍 · Massage Therapy · AI and more",freeText:"Start with free content before choosing a training program.",booksText:"eBooks and digital books to read at your own pace.",guidanceText:"Psychoanalytic and Career Guidance by text.",publicationText:"LDR Newspaper · LDR Magazine · LDR Science.",subText:"Access multiple digital contents with the LDR Essence Academy.",noResult:"No category found."},
  fr:{eyebrow:"VUE 360° DE LDR ESSENCE ACADEMY",title:"Trouvez tout sans faire défiler toute la page",sub:"Formations, contenus gratuits, livres, orientations et abonnements en un seul aperçu.",search:"Que voulez-vous apprendre ?",all:"Tout",formations:"Formations",free:"Gratuit",books:"Livres",guidance:"Orientations",publications:"Publications",subscriptions:"Abonnements",seeAll:"Voir tout le catalogue",from:"à partir de",month:"mois",week:"semaine",online:"100% en ligne",formationList:"Vente · Marketing · RH · Gestion · Communication · Psychanalyse · Psychanalyse Internationale 🌍 · Massothérapie · IA et plus",freeText:"Commencez par des contenus gratuits avant de choisir une formation.",booksText:"eBooks et livres numériques à lire à votre rythme.",guidanceText:"Orientation psychanalytique et professionnelle par écrit.",publicationText:"Journal LDR · Magazine LDR · LDR Science.",subText:"Accédez à plusieurs contenus numériques avec la LDR Essence Academy.",noResult:"Aucune catégorie trouvée."},
  es:{eyebrow:"VISTA 360° DE LDR ESSENCE ACADEMY",title:"Encuentra todo sin recorrer toda la página",sub:"Formaciones, contenidos gratuitos, libros, orientaciones y suscripciones en una vista rápida.",search:"¿Qué quieres aprender?",all:"Todo",formations:"Formaciones",free:"Gratis",books:"Libros",guidance:"Orientaciones",publications:"Publicaciones",subscriptions:"Suscripciones",seeAll:"Ver catálogo completo",from:"desde",month:"mes",week:"semana",online:"100% online",formationList:"Ventas · Marketing · RR. HH. · Gestión · Comunicación · Psicoanálisis · Psicoanálisis Internacional 🌍 · Masoterapia · IA y más",freeText:"Empieza con contenidos gratuitos antes de elegir una formación.",booksText:"eBooks y libros digitales para leer a tu ritmo.",guidanceText:"Orientación Psicoanalítica y Profesional por texto.",publicationText:"Periódico LDR · Revista LDR · LDR Ciencia.",subText:"Accede a varios contenidos digitales con la LDR Essence Academy.",noResult:"No se encontró ninguna categoría."}
} as const;
