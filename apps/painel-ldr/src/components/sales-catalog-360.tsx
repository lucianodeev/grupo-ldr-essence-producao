...
const COPY = {
  ...
  en:{eyebrow:"360° LDR ACADEMY VIEW",title:"Find everything without scrolling through the whole page",sub:"Training, free content, books, guidance and subscriptions in one quick view.",search:"What do you want to learn?",all:"All",formations:"Training",free:"Free",books:"Books",guidance:"Guidance",publications:"Publications",subscriptions:"Subscriptions",seeAll:"View full catalogue",from:"from",month:"month",week:"week",online:"100% online",formationList:"Sales · Marketing · HR · Management · Communication · Psychoanalysis · Massage Therapy · AI and more",freeText:"Start with free content before choosing a training program.",booksText:"eBooks and digital books to read at your own pace.",guidanceText:"Psychoanalytic and Career Guidance by text.",publicationText:"LDR Newspaper · LDR Magazine · LDR Science.",subText:"Access multiple digital contents with the LDR Academy.",noResult:"No category found."},
