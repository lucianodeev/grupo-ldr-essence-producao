...
const COPY = {
  pt: {
    ...
    cards: [
      ...
      ["6 encontros ao vivo", "São 2 por mês durante a primeira jornada. A participação é opcional e não bloqueia progresso nem certificado."],
    ...
    liveTitle: "Encontros ao vivo: apoio, não obrigação",
    liveText: "Os 6 encontros são espaços extras de conversa, dúvidas, empreendedorismo, networking e temas complementares. A presença não é obrigatória e não interfere na conclusão da formação.",
    ...
    lifetimeText: "O aluno pode rever aulas, perguntas, respostas, materiais e gravações quantas vezes quiser. Não precisa recomprar o treinamento.",
  ...
  en: {
    ...
    cards: [["3 months · 300 hours","Official completion requires at least 90 days, with lifetime content access afterwards."],["1 new question per day","A new step unlocks daily while future questions remain locked."],["Choice + written answer","Each activity requires an objective choice and a written justification."],["Review and improve","Unlocked questions can be revisited and answers improved after real-world testing."],["6 live meetings","Two per month. Participation is optional and does not block completion."],["1 reviewed business project","After 90 days, one individual project review is included."]],
    monthsTitle:"Three learning cycles", months:[["Month 1 · Foundations and diagnosis","Problem, customer, context, research and positioning."],["Month 2 · Building and validation","Offer, price, channels, testing, communication and costs."],["Month 3 · Execution and final project","Action plan, first customers, metrics and project consolidation."]], liveTitle:"Live meetings: support, not obligation", liveText:"The 6 meetings are optional spaces for conversation, questions, networking and complementary entrepreneurship topics.", projectTitle:"Final project with human feedback", projectText:"After 90 days, the student submits the project in the platform and receives corrections and feedback. One review is included; extra reviews cost R$179.90 or €29.90.", lifetimeTitle:"Lifetime access after the 3 months", lifetimeText:"Students can revisit content, questions, materials and recordings without repurchasing.", finalCta:"GET THE LAUNCH PRICE"
  },
  fr: {
