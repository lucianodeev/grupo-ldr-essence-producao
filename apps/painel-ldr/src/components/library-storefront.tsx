...
const COPY={
  pt:{eyebrow:"BIBLIOTECA LDR",title:"Bem-vindo à sua Biblioteca LDR",desc:"Conhecimento, bem-estar e oportunidades em um só lugar.",motto:"Aprenda hoje. Construa o seu amanhã.",search:"Buscar cursos, formações, livros, revistas ou jornais…",featured:"Destaques da Semana",featuredDesc:"Comece agora com conteúdos acessíveis e de alto valor.",newsstand:"Revista Psicanálise no Mundo",newsstandDesc:"A única revista editorial da LDR Essence Academy, com edição semanal.",bookstore:"Livraria LDR",bookstoreDesc:"eBooks, livros e produções especiais.",formations:"Formações",formationsDesc:"Construa novas habilidades e avance na sua carreira.",free:"Gratuitos",freeDesc:"Conteúdos gratuitos para começar agora.",all:"Todos",open:"Acessar",entry:"ACESSO SEMANAL",seeAll:"Ver todos"},
  en:{eyebrow:"LDR LIBRARY",title:"Welcome to your LDR Library",desc:"Knowledge, well-being and opportunities in one place.",motto:"Learn today. Build your tomorrow.",search:"Search courses, programs, books, magazines or newspapers…",featured:"Weekly Highlights",featuredDesc:"Start now with accessible, high-value content.",newsstand:"Psychoanalysis Around the World",newsstandDesc:"The LDR Essence Academy weekly editorial magazine.",bookstore:"LDR Bookstore",bookstoreDesc:"eBooks, books and special productions.",formations:"Programs",formationsDesc:"Build new skills and move your career forward.",free:"Free",freeDesc:"Free content to start now.",all:"All",open:"Open",entry:"WEEKLY ACCESS",seeAll:"See all"},
  fr:{eyebrow:"BIBLIOTHÈQUE LDR",title:"Bienvenue dans votre Bibliothèque LDR",desc:"Connaissance, bien-être et opportunités au même endroit.",motto:"Apprenez aujourd'hui. Construisez demain.",search:"Rechercher cours, formations, livres, magazines ou journaux…",featured:"À la une",featuredDesc:"Commencez avec des contenus accessibles et de grande valeur.",newsstand:"Revue Psychanalyse dans le Monde",newsstandDesc:"La revue éditoriale hebdomadaire de LDR Essence Academy.",bookstore:"Librairie LDR",bookstoreDesc:"eBooks, livres et productions spéciales.",formations:"Formations",formationsDesc:"Développez vos compétences et votre carrière.",free:"Gratuits",freeDesc:"Des contenus gratuits pour commencer.",all:"Tous",open:"Accéder",entry:"ACCÈS HEBDOMADAIRE",seeAll:"Voir tout"},
  es:{eyebrow:"BIBLIOTECA LDR",title:"Bienvenido a tu Biblioteca LDR",desc:"Conocimiento, bienestar y oportunidades en un solo lugar.",motto:"Aprende hoy. Construye tu mañana.",search:"Buscar cursos, formaciones, libros, revistas o periódicos…",featured:"Destacados de la Semana",featuredDesc:"Empieza con contenidos accesibles y de gran valor.",newsstand:"Revista Psicoanálisis en el Mundo",newsstandDesc:"La revista editorial semanal de LDR Essence Academy.",bookstore:"Librería LDR",bookstoreDesc:"eBooks, libros y producciones especiales.",formations:"Formaciones",formationsDesc:"Desarrolla habilidades y avanza en tu carrera.",free:"Gratuitos",freeDesc:"Contenidos gratuitos para empezar ahora.",all:"Todos",open:"Acceder",entry:"ACCESO SEMANAL",seeAll:"Ver todos"}
} as const;
...
const ITEMS:Item[]=[
  ...
  {title:"eBook A Coragem de Começar",subtitle:"Leitura digital para transformar coragem em ação.",href:"/cliente/biblioteca/ebook_coragem_comecar",icon:"📘",price:"R$ 9,90 · € 4,90",tag:"ebook coragem começar",group:"livraria",color:"#5b0824",badge:"DESTAQUE"},
  {title:"O Menino que Vendia Mamão",subtitle:"Livro de Luciano Rodrigues Almeida sobre coragem, iniciativa e construção de oportunidades.",href:"/cliente/biblioteca/livro_menino_mamao",icon:"📕",price:"R$ 49,90 · € 20,00",tag:"livro menino vendia mamão coragem empreendedorismo",group:"livraria",color:"#7a3f16",badge:"LIVRO"},
  ...
  {title:"Do Mamão ao Negócio",subtitle:"Treinamento para transformar uma ideia em negócio, oferta e plano de execução.",href:"/cliente/treinamentos/do-mamao-ao-negocio",icon:"🥭",tag:"mamão negocio empreendedorismo treinamento oferta vendas",group:"formacoes",color:"#9a4f13",badge:"TREINAMENTO"},
  {title:"Psicanálise",subtitle:"Formação online em Psicanálise.",href:"/cliente/treinamentos/psicanalise",icon:"🧠",tag:"psicanálise formação",group:"formacoes",color:"#5b2b86"},
