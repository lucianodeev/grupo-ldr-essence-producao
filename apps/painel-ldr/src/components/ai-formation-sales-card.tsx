...
const COPY={
  pt:{eyebrow:"FORMAÇÃO",title:"Formação em Inteligência Artificial Aplicada aos Negócios e à Carreira",desc:"Aprenda a usar IA para criar conteúdo, programar, estruturar produtos digitais, vender, automatizar processos e desenvolver soluções reais.",meta:"600 horas · 15 módulos · 225 aulas · 100% online · 6 avaliações de projeto",price:"R$ 299,99 · € 49,90",payment:"PAGAMENTO ÚNICO · ACESSO VITALÍCIO",cta:"CONHECER A FORMAÇÃO"},
  en:{eyebrow:"PROGRAM",title:"Artificial Intelligence Applied to Business and Career",desc:"Learn to use AI to create content, build software, structure digital products, sell, automate processes and develop real solutions.",meta:"600 hours · 15 modules · 225 lessons · 100% online · 6 project assessments",price:"R$ 299,99 · € 49,90",payment:"ONE-TIME PAYMENT · LIFETIME ACCESS",cta:"VIEW PROGRAM"},
  fr:{eyebrow:"FORMATION",title:"Intelligence Artificielle Appliquée aux Entreprises et à la Carrière",desc:"Apprenez à utiliser l’IA pour créer du contenu, programmer, structurer des produits numériques, vendre, automatiser des processus et développer des solutions concrètes.",meta:"600 heures · 15 modules · 225 cours · 100% en ligne · 6 évaluations de projet",price:"R$ 299,99 · € 49,90",payment:"PAIEMENT UNIQUE · ACCÈS À VIE",cta:"DÉCOUVRIR LA FORMATION"},
  es:{eyebrow:"FORMACIÓN",title:"Inteligencia Artificial Aplicada a los Negocios y a la Carrera",desc:"Aprende a usar IA para crear contenido, programar, estructurar productos digitales, vender, automatizar procesos y desarrollar soluciones reales.",meta:"600 horas · 15 módulos · 225 clases · 100% online · 6 evaluaciones de proyecto",price:"R$ 299,99 · € 49,90",payment:"PAGO ÚNICO · ACCESO DE POR VIDA",cta:"CONOCER LA FORMACIÓN"}
} as const;
