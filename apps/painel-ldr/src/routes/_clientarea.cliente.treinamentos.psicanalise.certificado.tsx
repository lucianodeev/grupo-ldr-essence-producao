...
function PsychoanalysisCertificate(){
 ...
 return <div className="mx-auto max-w-5xl space-y-4 pb-10">
   ...
   <section className="border-[10px] border-double border-[#5b2b86] bg-[#fffdf9] p-7 text-center shadow-xl print:shadow-none sm:p-12">
     ...
     <p className="mx-auto mt-4 max-w-3xl text-sm leading-7 text-[#66576f]">Formação livre em Psicanálise. Referência ocupacional no Brasil: Psicanalista — Classificação Brasileira de Ocupações (CBO) 2515-50. Este certificado comprova a conclusão do percurso formativo e pode ser apresentado para fins de atuação profissional, observadas as regras e exigências aplicáveis no local de exercício. Não equivale a graduação universitária.</p>
