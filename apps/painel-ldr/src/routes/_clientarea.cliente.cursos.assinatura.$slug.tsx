...
const UI={
  pt:{badge:"INCLUÍDO NA ASSINATURA",module:"Módulo",progress:"Seu progresso",prev:"Anterior",next:"Próximo",done:"Marcar concluído",completed:"Concluído",topics:"Pontos de estudo",activity:"Atividade aplicada",certificate:"Certificado de 60 horas após a conclusão dos requisitos do curso.",checking:"Verificando sua assinatura…",locked:"Este curso é exclusivo para assinantes da LDR Essence Academy.",subscribe:"VER ASSINATURA",notFound:"Curso não encontrado.",hours:"60 horas · Curso Livre · 100% online"},
  en:{badge:"INCLUDED IN SUBSCRIPTION",module:"Module",progress:"Your progress",prev:"Previous",next:"Next",done:"Mark complete",completed:"Completed",topics:"Study points",activity:"Applied activity",certificate:"60-hour certificate after completing the course requirements.",checking:"Checking your subscription…",locked:"This course is exclusive to LDR Essence Academy subscribers.",subscribe:"VIEW SUBSCRIPTION",notFound:"Course not found.",hours:"60 hours · Non-degree course · 100% online"},
  fr:{badge:"INCLUS DANS L’ABONNEMENT",module:"Module",progress:"Votre progression",prev:"Précédent",next:"Suivant",done:"Marquer terminé",completed:"Terminé",topics:"Points d’étude",activity:"Activité appliquée",certificate:"Certificat de 60 heures après validation des exigences du cours.",checking:"Vérification de votre abonnement…",locked:"Ce cours est réservé aux abonnés de la LDR Essence Academy.",subscribe:"VOIR L’ABONNEMENT",notFound:"Cours introuvable.",hours:"60 heures · Cours libre · 100% en ligne"},
  es:{badge:"INCLUIDO EN LA SUSCRIPCIÓN",module:"Módulo",progress:"Tu progreso",prev:"Anterior",next:"Siguiente",done:"Marcar completado",completed:"Completado",topics:"Puntos de estudio",activity:"Actividad aplicada",certificate:"Certificado de 60 horas tras completar los requisitos del curso.",checking:"Verificando tu suscripción…",locked:"Este curso es exclusivo para suscriptores de LDR Essence Academy.",subscribe:"VER SUSCRIPCIÓN",notFound:"Curso no encontrado.",hours:"60 horas · Curso libre · 100% online"},
} as const;
...
function Page(){
  ...
  return <div className="space-y-5 pb-10">
    <section className="rounded-[28px] bg-gradient-to-br from-[#071426] via-[#0b2341] to-[#163b67] p-6 text-white">
      ...
      <p className="mt-3 text-sm font-semibold text-white/70">{u.hours}</p>
      <p className="mt-2 text-sm text-[#f4d99a]">{u.certificate}</p>
