...
const COPY = {
  pt: { choose:"Escolha sua área de acesso", enter:"Entrar →", privacy:"Cada perfil acessa somente as informações autorizadas para sua função.", company:"Empresa", companyText:"Gerencie funcionários, benefícios, serviços e pagamentos corporativos.", employee:"Minha Área", employeeText:"Veja e utilize os benefícios disponibilizados pela sua empresa.", professional:"Profissional", professionalText:"Central operacional para profissionais autorizados do Grupo LDR Essence.", client:"Minha Área", clientText:"Acompanhe compras, agenda, biblioteca, mentoria e serviços individuais." },
  en: { choose:"Choose your access area", enter:"Enter →", privacy:"Each profile can only access information authorized for its role.", company:"Company", companyText:"Manage employees, benefits, services and corporate payments.", employee:"My Area", employeeText:"View and use the benefits made available by your company.", professional:"Professional", professionalText:"Operations hub for authorized Grupo LDR Essence professionals.", client:"My Area", clientText:"Track purchases, schedule, library, mentorship and individual services." },
  fr: { choose:"Choisissez votre espace d’accès", enter:"Entrer →", privacy:"Chaque profil accède uniquement aux informations autorisées pour son rôle.", company:"Entreprise", companyText:"Gérez les collaborateurs, avantages, services et paiements de l’entreprise.", employee:"Mon espace", employeeText:"Consultez et utilisez les avantages mis à disposition par votre entreprise.", professional:"Professionnel", professionalText:"Centre opérationnel réservé aux professionnels autorisés du Grupo LDR Essence.", client:"Mon espace", clientText:"Suivez vos achats, rendez-vous, bibliothèque, mentorat et services individuels." },
  es: { choose:"Elige tu área de acceso", enter:"Entrar →", privacy:"Cada perfil accede únicamente a la información autorizada para su función.", company:"Empresa", companyText:"Gestiona empleados, beneficios, servicios y pagos corporativos.", employee:"Mi Área", employeeText:"Consulta y utiliza los beneficios ofrecidos por tu empresa.", professional:"Profesional", professionalText:"Centro operativo para profesionales autorizados de Grupo LDR Essence.", client:"Minha Área", clientText:"Sigue compras, agenda, biblioteca, mentoría y servicios individuales." },
} as const;
