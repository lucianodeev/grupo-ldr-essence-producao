...
function Page(){
  ...
  if(!ebook) return <main className="mx-auto max-w-3xl px-4 py-16"><h1 className="font-serif text-3xl">eBook não encontrado.</h1><a className="mt-6 inline-flex rounded-xl bg-[#071426] px-5 py-3 text-sm font-black text-white" href="/">Voltar para a LDR Academy</a></main>;
