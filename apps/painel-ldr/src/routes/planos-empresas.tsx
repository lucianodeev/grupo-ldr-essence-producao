...
const COPY = {
  pt: {
    ...
    checkoutNote: "Entre na Área da Empresa para revisar a configuração e continuar para o checkout Stripe com renovação mensal automática.",
  ...
  en: {
    ...
    checkoutNote: "Sign in to the Company Area to review the configuration and continue to Stripe Checkout with automatic monthly renewal.",
  ...
  fr: {
    ...
    checkoutNote: "Connectez-vous à l’Espace Entreprise pour vérifier la configuration et poursuivre vers Stripe Checkout avec renouvellement mensuel automatique.",
  ...
  es: {
    ...
    checkoutNote: "Entra en el Área de Empresa para revisar la configuración y continuar a Stripe Checkout con renovación mensual automática.",
