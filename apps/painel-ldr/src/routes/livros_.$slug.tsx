...
function Page(){
  ...
  if(slug!=="o-menino-que-vendia-mamao") return <main className="mx-auto max-w-3xl px-4 py-16"><h1 className="font-serif text-3xl">Livro não encontrado.</h1><a className="mt-6 inline-flex rounded-xl bg-[#071426] px-5 py-3 text-sm font-black text-white" href="/">Voltar para a LDR Academy</a></main>;
  return <main className="min-h-screen bg-[#f7f3e9] text-[#071426]">
    <section className="bg-gradient-to-br from-[#7a3f16] to-[#071426] px-4 py-16 text-white">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mt-5 text-xs font-black tracking-[.2em] text-[#d6ad63]">LIVRO · LDR ACADEMY</p>
        ...
        <p className="mt-3 text-xs text-white/65">Pagamento único · acesso pela Biblioteca LDR Academy.</p>
      </div>
    </section>
