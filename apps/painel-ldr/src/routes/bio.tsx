...
const COPY = {
  pt: {
    ...
    magazineDesc: "Conteúdo exclusivo sobre psicanálise, ciência, comportamento, cultura e estudos no mundo.", magazineNote: "Assinatura semanal recorrente, separada da assinatura principal da biblioteca.",
    ...
    subMagazine: "ASSINAR REVISTA", startPsycho: "INICIAR ORIENTAÇÃO", startCareer: "FALAR SOBRE MINHA CARREIRA",
    clinic: "Clínica Social", clinicSub: "Acolhimento e cuidado acessível para quem precisa.", clinicCta: "CONHECER A CLÍNICA SOCIAL",
    formations: "Formações e cursos", formationsSub: "Formações atuais por R$ 299,99 · € 49,90", free: "Cursos gratuitos", freeSub: "Comece a aprender sem custo", student: "Já sou aluno", studentSub: "Entre para acessar sua Biblioteca", borders: "Conhecimento sem fronteiras", linksAria: "Links principais da LDR Essence Academy",
  },
  en: {
    ...
    magazineDesc: "Exclusive content on psychoanalysis, science, behavior, culture and studies from around the world.", magazineNote: "Recurring weekly subscription, separate from the main library subscription.",
    ...
    subMagazine: "SUBSCRIBE TO MAGAZINE", startPsycho: "START GUIDANCE", startCareer: "TALK ABOUT MY CAREER",
    clinic: "Social Clinic", clinicSub: "Accessible support and care for those who need it.", clinicCta: "VISIT THE SOCIAL CLINIC",
    formations: "Training and courses", formationsSub: "Current training: R$ 299.99 · € 49.90", free: "Free courses", freeSub: "Start learning at no cost", student: "I'm already a student", studentSub: "Sign in to access your Library", borders: "Knowledge without borders", linksAria: "Main LDR Essence Academy links",
  },
  fr: {
    ...
    magazineDesc: "Contenu exclusif sur la psychanalyse, la science, le comportement, la culture et les études dans le monde.", magazineNote: "Abonnement hebdomadaire récurrent, séparé de l'abonnement principal à la bibliothèque.",
    ...
    subMagazine: "S'ABONNER AU MAGAZINE", startPsycho: "COMMENCER L'ORIENTATION", startCareer: "PARLER DE MA CARRIÈRE",
    clinic: "Clinique Sociale", clinicSub: "Un accueil et un accompagnement accessibles à ceux qui en ont besoin.", clinicCta: "DÉCOUVRIR LA CLINIQUE SOCIALE",
    formations: "Formations et cours", formationsSub: "Formations actuelles : R$ 299,99 · 49,90 €", free: "Cours gratuits", freeSub: "Commencez à apprendre gratuitement", student: "Je suis déjà élève", studentSub: "Connectez-vous pour accéder à votre Bibliothèque", borders: "Le savoir sans frontières", linksAria: "Liens principaux de LDR Essence Academy",
  },
  es: {
    ...
    magazineDesc: "Contenido exclusivo sobre psicoanálisis, ciencia, comportamiento, cultura y estudios en el mundo.", magazineNote: "Suscripción semanal recurrente, separada de la suscripción principal de la biblioteca.",
    ...
    subMagazine: "SUSCRIBIRME A LA REVISTA", startPsycho: "INICIAR ORIENTACIÓN", startCareer: "HABLAR SOBRE MI CARRERA",
    clinic: "Clínica Social", clinicSub: "Acogida y atención accesible para quienes la necesitan.", clinicCta: "CONOCER LA CLÍNICA SOCIAL",
    formations: "Formaciones y cursos", formationsSub: "Formaciones actuales por R$ 299,99 · € 49,90", free: "Cursos gratuitos", freeSub: "Empieza a aprender sin costo", student: "Ya soy alumno", studentSub: "Entra para acceder a tu Biblioteca", borders: "Conocimiento sin fronteras", linksAria: "Enlaces principales de LDR Essence Academy",
  },
} as const;
...
function BioPage(){
  ...
  return <main className="min-h-screen px-4 py-8 sm:py-12" style={{background:"radial-gradient(circle at top, rgba(201,155,45,.14), transparent 30%), linear-gradient(180deg, #fbfaf7 0%, #f7f2e8 100%)",color:NAVY_DARK}}><div className="mx-auto w-full max-w-2xl">
    ...
    <header className="mb-7 text-center"><div className="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-[24px] shadow-sm" style={{background:NAVY}} aria-hidden="true"><BookOpen size={40} color={GOLD} strokeWidth={1.8}/></div><p className="mb-2 text-xs font-bold uppercase tracking-[0.24em]" style={{color:GOLD}}>Learn · Discover · Grow</p><h1 className="font-serif text-4xl font-bold tracking-tight" style={{color:NAVY}}>LDR Essence Academy</h1><p className="mx-auto mt-3 max-w-lg text-sm leading-6 text-slate-600">{c.intro}</p></header>
    ...
    <section className="mt-7"><div className="mb-4 text-center"><p className="text-xs font-black uppercase tracking-[.16em]" style={{color:GOLD}}>{c.section}</p><h2 className="mt-2 font-serif text-2xl" style={{color:NAVY}}>{c.choose}</h2></div><div className="grid gap-4 sm:grid-cols-2">
      <PriceCard title="Revista Psicanálise no Mundo" kicker={c.weekly} description={c.magazineDesc} price="🇧🇷 R$ 3,90 / semana" secondaryPrice="🇪🇺 € 3,90 / semana" note={c.magazineNote} to="/cliente/biblioteca/publicacoes/revista-psicanalise-no-mundo" cta={c.subMagazine} tone="wine" icon={<BookOpen size={23} color="#f0c775"/>}/>
