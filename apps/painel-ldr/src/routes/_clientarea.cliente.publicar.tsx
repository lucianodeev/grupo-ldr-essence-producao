...
const COPY = {
  pt: {
    title: "Publique na LDR Essence Academy",
    intro: "Você cria. A LDR Essence Academy hospeda, vende e entrega. Você recebe 85% de cada venda.",
    ...
    priceNote: "O preço final será aprovado pela LDR Essence Academy antes da publicação.",
  },
  en: {
    title: "Publish on LDR Essence Academy",
    intro: "You create. LDR Essence Academy hosts, sells and delivers. You receive 85% of each sale.",
    ...
    submit: "SUBMIT FOR REVIEW", sending: "Submitting…", mine: "My products", empty: "You have not submitted any products yet.", first: "PUBLISH MY FIRST PRODUCT", suggested: "Suggested price", priceNote: "The final price must be approved by LDR Essence Academy before publication.",
  },
  fr: {
    title: "Publiez sur LDR Essence Academy",
    intro: "Vous créez. LDR Essence Academy héberge, vend et livre. Vous recevez 85 % de chaque vente.",
    ...
    submit: "ENVOYER POUR VALIDATION", sending: "Envoi…", mine: "Mes produits", empty: "Vous n'avez encore soumis aucun produit.", first: "PUBLIER MON PREMIER PRODUIT", suggested: "Prix suggéré", priceNote: "Le prix final doit être approuvé par LDR Essence Academy avant publication.",
  },
  es: {
    title: "Publica en LDR Essence Academy",
    intro: "Tú creas. LDR Essence Academy aloja, vende y entrega. Recibes el 85 % de cada venta.",
    ...
    submit: "ENVIAR A REVISIÓN", sending: "Enviando…", mine: "Mis productos", empty: "Aún no has enviado ningún producto.", first: "PUBLICAR MI PRIMER PRODUCTO", suggested: "Precio sugerido", priceNote: "El precio final debe ser aprobado por LDR Essence Academy antes de publicarse.",
  },
} as const;
