...
const COPY = {
  pt: {
    ...
    paymentText: "Pagamento seguro. Após a contratação, acompanhe os próximos passos pela sua Minha Área.",
  ...
  en: {
    ...
    paymentText: "Secure payment. After purchase, follow the next steps in your My Area.", buyNow: "Buy now", unavailable: "Checkout temporarily unavailable",
  ...
  es: {
    ...
    paymentText: "Pago seguro. Después de contratar, sigue los próximos pasos desde tu Mi Área.", buyNow: "Contratar ahora", unavailable: "Checkout temporalmente no disponible",
