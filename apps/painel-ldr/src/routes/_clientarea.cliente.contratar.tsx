...
const COPY = {
  pt: {
    ...
    paymentText: "Pagamento seguro. Após a contratação, acompanhe os próximos passos pela Minha Área.",
    ...
    availability: "Agendamento com antecedência mínima de 7 dias",
  ...
  en: {
    ...
    paymentText: "Secure payment. After purchase, follow the next steps in My Area.", buyNow: "Buy now", unavailable: "Checkout temporarily unavailable",
    wellbeingEyebrow: "Corporate wellbeing", wellbeingTitle: "Workplace Massage and LDR Wellbeing Hour",
    availability: "Booking requires at least 7 days' notice",
  ...
  fr: {
    ...
    paymentText: "Paiement sécurisé. Après l’achat, suivez les prochaines étapes dans votre espace personnel.", buyNow: "Souscrire maintenant", unavailable: "Checkout temporairement indisponible",
    wellbeingEyebrow: "Bien-être en entreprise", wellbeingTitle: "Massage en entreprise et Heure Bien-Être LDR",
    availability: "Réservation avec un préavis minimum de 7 jours",
  ...
  es: {
    ...
    paymentText: "Pago seguro. Después de contratar, sigue los próximos pasos desde Mi Área.", buyNow: "Contratar ahora", unavailable: "Checkout temporalmente no disponible",
    wellbeingEyebrow: "Bienestar corporativo", wellbeingTitle: "Masaje Laboral y Hora de Bienestar LDR",
    availability: "Reserva con una antelación mínima de 7 días",
...
function CorporateWellbeing({ copy, locale }: { copy: Copy; locale: Locale }) {
  ...
  const wellbeingUrl = `https://ldracademy.online/bem-estar?lang=${locale}#hora-bem-estar-ldr`;
  return (
