...
const SUB_TXT={
  ...
  fr:{eyebrow:"ACCÈS TOTAL",title:"Abonnez-vous à Biblioteca LDR",desc:"Un seul abonnement donne accès aux contenus numériques indiqués como inclus tant qu'il reste actif. Les achats à l'unité restent accessibles à vie.",included:"Cours, formations, eBooks et livres indiqués comme inclus",subscribe:"S'ABONNER",active:"Abonnement actif",cancel:"Annuler à la fin de la période",keep:"Maintenir l'abonnement",ending:"Annulation programmée"},
