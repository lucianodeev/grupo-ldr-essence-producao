...
const HUB_COPY = {
  ...
  en: [
    ...
    { name:"Human Room", url:"/human-room", tag:"Connected project", desc:"A global space for listening, humanity, reflection and real stories." },
  ...
  fr: [
    ...
    { name:"Human Room", url:"/human-room", tag:"Projet connecté", desc:"Un espace mondial d’écoute, d’humanité, de réflexion et d’histoires réelles." },
  ...
  es: [
    ...
    { name:"Human Room", url:"/human-room", tag:"Proyecto conectado", desc:"Un espacio global de escucha, humanidad, reflexión e historias reales." },
