...
export const Route = createFileRoute("/ecossistema")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Mapa central com os principais links do ecossistema LDR: Academy, LDR PASS, Biblioteca, Rede Acadêmica, Admin, Clínica Social, LDR RH & Estratégia e Human Room." },
    ],
  }),
...
const hubs = [
  ...
  { name: "Mapa do Ecossistema", url: "/ecossistema", tag: "Central de links", desc: "Página que conecta todas as entradas do ecossistema e evita páginas soltas." },
  ...
  { name: "Admin central LDR", url: "/admin", tag: "Gestão protegida", desc: "Painel simples/protegido para controlar catálogo, treinamentos internos, Biblioteca, Rede Acadêmica, financeiro, clientes e operações." },
    ...
    <main className="min-h-screen bg-[#f8f1e7] text-[#25170f]">
      <section className="mx-auto max-w-6xl px-5 py-12 sm:py-16">
        ...
        <div className="mt-7 rounded-[34px] border border-[#d6ad63]/40 bg-white p-6 shadow-xl sm:p-9">
          ...
          <p className="mt-4 max-w-3xl text-base text-[#6f6358]">Cada projeto mantém sua individualidade, mas todas as entradas agora se referenciam: vendas, LDR PASS, Biblioteca, Rede Acadêmica, Admin central, Clínica Social, LDR RH & Estratégia e Human Room.</p>
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <a href="/admin" className="rounded-full border border-[#1d3158] px-5 py-3 text-sm font-black uppercase tracking-[.12em] text-[#1d3158]">Admin central</a>
          </div>
        </div>
