...
export const Route = createFileRoute("/formacao-psicanalise")({
 head:()=>({meta:[
  ...
  {name:"description",content:"Formação Online em Psicanálise: 10 módulos, 6 encontros ao vivo, leituras orientadas, atividades e acesso vitalício aos conteúdos digitais."},
 ]}),
