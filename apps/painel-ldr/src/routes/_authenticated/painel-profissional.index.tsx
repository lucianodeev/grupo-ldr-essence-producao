...
const COPY = {
  pt: {
    title: "Visão geral", subtitle: "Aqui você acompanha o que precisa da sua atenção e continua seu trabalho.", orders: "Pedidos", new: "Novos", inProgress: "Em andamento", waitingClient: "Aguardando cliente", completed: "Concluídos", cancelled: "Cancelados", clients: "Clientes", activeMentorships: "Mentorias ativas", total: "no total", pendingDeliveries: "Entregas pendentes", openOrders: "Pedidos abertos", byService: "Pedidos por tipo de serviço", noOrders: "Nenhum pedido registrado até o momento.", recent: "Atividade recente", recentEmpty: "Tudo tranquilo por aqui. Quando houver uma nova atividade, ela aparecerá neste espaço.", system: "sistema", before: "antes", emptyTitle: "Ainda não há pedidos na central", emptyDescription: "Cadastre o primeiro pedido para começar a acompanhar prazos, responsáveis e entregas.", goOrders: "Ir para Pedidos", latest: "Últimos pedidos",
  },
  en: {
