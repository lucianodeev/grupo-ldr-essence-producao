...
const NAV = [
  ...
  { to: "/painel-profissional/rede-planos", extra: "networkPlans", superOnly: true },
...
function CentralLayout() {
  ...
  const items = isSuperadmin
    ? [{ to: "/admin", label: copy.master }, ...baseItems, { to: "/painel-profissional/psicanalise", label: t("nav.clinical") }, { to: "/painel-profissional/acessos", label: t("nav.access") }]
    : baseItems;
