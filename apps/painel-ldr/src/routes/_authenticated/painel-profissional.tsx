...
const COPY = {
  ...
  en: { companies: "Companies / Employees", network: "Professional Network", networkServices: "Network · Services", networkPlans: "Network · Plans", networkFinance: "Network · Finance", networkPayouts: "Network · Payouts", networkCompliance: "Network · Compliance", networkContent: "Network · Training / Community", notifications: "Notifications", training: "Training / Content", comments: "Comments / Forum", profile: "role", denied: "Your account is not authorized to access this operations hub." },
