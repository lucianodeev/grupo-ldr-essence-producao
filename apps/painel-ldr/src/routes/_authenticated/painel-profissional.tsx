...
const PROFESSIONAL_NAV = [
  ...
  { to: "/painel-profissional/disponibilidade", extra: "availability" },
  { to: "/painel-profissional/clinica-social", extra: "socialClinic" },
...
const ADMIN_NAV = [
  { to: "/painel-profissional/conteudos-criadores", extra: "creatorContent" },
...
const COPY = {
  pt: { creatorContent: "Conteúdos de Criadores", companies: "Empresas / Funcionários", network: "Rede de Profissionais", networkServices: "Rede · Serviços", networkFinance: "Rede · Financeiro", networkPayouts: "Rede · Repasses", networkCompliance: "Rede · Conformidade", networkContent: "Rede · Treinamentos / Comunidade", networkReviews: "Rede · Avaliações", availability: "Minha disponibilidade", socialClinic: "Clínica Social", notifications: "Notificações", training: "Treinamentos / Conteúdos", comments: "Comentários / Fórum", profile: "perfil", denied: "Sua conta não possui autorização para acessar o Painel do Profissional.", adminDenied: "Esta área administrativa é exclusiva do Painel Master LDR.", master: "Painel Master LDR" },
  en: { creatorContent: "Creator Content", companies: "Companies / Employees", network: "Professional Network", networkServices: "Network · Services", networkFinance: "Network · Finance", networkPayouts: "Network · Payouts", networkCompliance: "Network · Compliance", networkContent: "Network · Training / Community", networkReviews: "Network · Reviews", availability: "My availability", socialClinic: "Social Clinic", notifications: "Notifications", training: "Training / Content", comments: "Comments / Forum", profile: "role", denied: "Your account is not authorized to access the Professional Panel.", adminDenied: "This administrative area is exclusive to the LDR Master Panel.", master: "LDR Master Panel" },
  fr: { creatorContent: "Contenus des créateurs", companies: "Entreprises / Collaborateurs", network: "Réseau de Professionnels", networkServices: "Réseau · Services", networkFinance: "Réseau · Finance", networkPayouts: "Réseau · Reversements", networkCompliance: "Réseau · Conformité", networkContent: "Réseau · Formations / Communauté", networkReviews: "Réseau · Avis", availability: "Mes disponibilités", socialClinic: "Clinique Sociale", notifications: "Notifications", training: "Formations / Contenus", comments: "Commentaires / Forum", profile: "profil", denied: "Votre compte n’est pas autorisé à accéder au Panneau Professionnel.", adminDenied: "Cette zone administrative est réservée au Panneau Master LDR.", master: "Panneau Master LDR" },
  es: { creatorContent: "Contenidos de Creadores", companies: "Empresas / Empleados", network: "Red de Profesionales", networkServices: "Red · Servicios", networkFinance: "Red · Finanzas", networkPayouts: "Red · Pagos", networkCompliance: "Red · Cumplimiento", networkContent: "Red · Formación / Comunidad", networkReviews: "Red · Opiniones", availability: "Mi disponibilidad", socialClinic: "Clínica Social", notifications: "Notificaciones", training: "Formaciones / Contenidos", comments: "Comentarios / Foro", profile: "perfil", denied: "Tu cuenta no está autorizada para acceder al Panel Profesional.", adminDenied: "Esta área administrativa es exclusiva del Panel Master LDR.", master: "Panel Master LDR" },
} as const;
