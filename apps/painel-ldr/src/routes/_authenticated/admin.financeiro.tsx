...
function FinanceiroAdmin() {
  ...
  return <div className="space-y-6">
    ...
    <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
      <Link to="/admin/profissionais-financeiro" className="rounded-2xl border border-[#C7A33B]/40 bg-white p-5 shadow-sm"><h2 className="font-serif text-xl text-[#0B1F3A]">Financeiro da Rede</h2><p className="mt-2 text-sm text-slate-600">Movimentações financeiras ligadas à Rede de Profissionais.</p><span className="mt-4 inline-block text-sm font-bold text-[#0B1F3A]">Abrir →</span></Link>
      <Link to="/admin/profissionais-repasses" className="rounded-2xl border border-[#C7A33B]/40 bg-white p-5 shadow-sm"><h2 className="font-serif text-xl text-[#0B1F3A]">Repasses</h2><p className="mt-2 text-sm text-slate-600">Acompanhar repasses e valores destinados aos profissionais.</p><span className="mt-4 inline-block text-sm font-bold text-[#0B1F3A]">Abrir →</span></Link>
      ...
      <Link to="/admin/alunos-matriculas" className="rounded-2xl border border-[#C7A33B]/40 bg-white p-5 shadow-sm"><h2 className="font-serif text-xl text-[#0B1F3A]">Alunos e Matrículas</h2><p className="mt-2 text-sm text-slate-600">Consultar alunos, cursos, acessos gratuitos, avulsos e por assinatura.</p><span className="mt-4 inline-block text-sm font-bold text-[#0B1F3A]">Abrir →</span></Link>
    </section>
