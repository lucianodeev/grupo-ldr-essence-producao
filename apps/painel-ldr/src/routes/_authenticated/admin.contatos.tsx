...
function ContactsAdmin() {
 ...
 async function change(id:string,status:typeof statuses[number]) { await updater({data:{id,status,priority:"normal"}}); await qc.invalidateQueries({queryKey:["ecosystem-contacts"]}); }
