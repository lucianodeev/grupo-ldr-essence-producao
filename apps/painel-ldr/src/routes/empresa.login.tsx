...
function CompanyLogin() {
  ...
  useEffect(() => {
    ...
    const { data } = supabase.auth.onAuthStateChange((event, session) => { if (active && session && (event === "SIGNED_IN" || event === "INITIAL_SESSION" || event === "TOKEN_REFRESHED")) window.location.replace("/empresa"); });
