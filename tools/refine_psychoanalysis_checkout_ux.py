...
# Internal course: correct commercial prices and improve module navigation on mobile.
...
# Library: remove obsolete psychoanalysis promotional price and display the same commercial reference as Hotmart.
...
if old not in s: raise SystemExit('psycho price panel anchor not found')
